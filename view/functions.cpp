...
void visualizarNotasDelProyecto(const Project& proyecto) {
    ...
    cout<<"Notas para el proyecto "<<proyecto.getTitle()<<": "<<endl;

    // Mostrar las notas
    for (const Note& nota : notas) {
        cout<<"Título: "<<nota.getTitle()<<endl;
        cout<<"Contenido: "<<nota.getContent()<<endl;
        cout<<"Autor: "<<nota.getAuthor().getUsername()<<endl;
        cout<<"------------------------"<<endl;
    }
}
...
void mostrarTareasOrdenadasPorPrioridad(Project& proyecto) {
    ...
    for (const Task& tarea : tareas) {
        cout<<"Título: "<<tarea.getTitle()<<endl;
        cout<<"Prioridad: "<<tarea.getPriority()<<endl;
        cout<<"------------------------"<<endl;
    }
}
...
void mostrarTareasOrdenadasPorEstado(Project& proyecto) {
    ...
    for (const Task& tarea : tareas) {
        cout<<"Título: "<<tarea.getTitle()<<endl;
        cout<<"Estado: "<<tarea.getState()<<endl;
        cout<<"------------------------"<<endl;
    }
}